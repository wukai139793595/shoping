...
<div v-if='addressList!=null && addressList.length>0' class='address-list container'>
  <div  v-for='(item,index) in addressList' :key='index' class='address-item' @click='select(item)'>
    ...
    <div class='address-bottom'>
      <div class='address-default' @click.stop='changDefault(item)' >
      ...
      <div class='address-right'>
        ...
        <div class='delete' @click.stop='deleteAddress(item)'>
...
<div class='no-address-box' v-else>
  <img src='../../assets/img/no-address.png'/>
  <p>您还未添加地址</p>
</div>
